...
import {
    ArrowUpDown, BanknoteArrowUp,
    ChevronDown,
    ChevronLeft,
    ChevronRight, CreditCard, FileTextIcon, FolderClosed,
    Info,
    ListFilter,
    MoreHorizontal,
    MoreVertical
        ...
        <div className="min-h-screen space-y-4">
            ...
            <div className="mt-4">
                {activeTab === "total-invoices" && (
                    <div
                        className="mx-auto w-full md:w-[calc(100vw-304px)]  flex flex-col gap-4">
