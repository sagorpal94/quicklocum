                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 h-full">
                            ...
                            <div className="flex flex-col md:flex-row gap-6 h-full w-full">
                                <div
                                    ...
                                    <div className="space-y-1">
                                        <h2 className="text-sm font-semibold text-[#102A56] leading-none tracking-tight">Financial</h2>
                                    </div>
                    ...
                    <div className="lg:col-span-1 h-full relative">
                        <div
                            ...
                            <h2 className="text-sm font-medium text-[#102A56]">Applications</h2>
                            <div
                            ...
                            <h3 className="text-sm font-normal text-[#404040] mb-1">New Applicants</h3>
